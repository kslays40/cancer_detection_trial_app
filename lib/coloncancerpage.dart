...
class coloncancpage extends StatefulWidget {
  const coloncancpage({Key? key}) : super(key: key);

  @override
  State<coloncancpage> createState() => _coloncancpageState();
}

class _coloncancpageState extends State<coloncancpage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: coloncanchomepage(),
    );
  }
}


class coloncanchomepage extends StatefulWidget {
  const coloncanchomepage({Key? key}) : super(key: key);

  @override
  State<coloncanchomepage> createState() => _coloncanchomepageState();
}

class _coloncanchomepageState extends State<coloncanchomepage> {
  ...
  loadModel() async {
    await Tflite.loadModel(
        model: 'assetcolon/model_unquant.tflite', labels: 'assetcolon/labels.txt');
  }
