...
class skincancpage extends StatefulWidget {
  const skincancpage({Key? key}) : super(key: key);

  @override
  State<skincancpage> createState() => _skincancpageState();
}

class _skincancpageState extends State<skincancpage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: skincanchomepage(),
    );
  }
}


class skincanchomepage extends StatefulWidget {
  const skincanchomepage({Key? key}) : super(key: key);

  @override
  State<skincanchomepage> createState() => _skincanchomepageState();
}

class _skincanchomepageState extends State<skincanchomepage> {
  ...
  loadModel() async {
    await Tflite.loadModel(
        model: 'assetskin/model_unquant.tflite', labels: 'assetskin/labels.txt');
  }
