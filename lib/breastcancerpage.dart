...
class breastcancpage extends StatefulWidget {
  const breastcancpage({Key? key}) : super(key: key);

  @override
  State<breastcancpage> createState() => _breastcancpageState();
}

class _breastcancpageState extends State<breastcancpage> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: breastcanchomepage(),
    );
  }
}

class breastcanchomepage extends StatefulWidget {
  const breastcanchomepage({Key? key}) : super(key: key);

  @override
  State<breastcanchomepage> createState() => _breastcanchomepageState();
}

class _breastcanchomepageState extends State<breastcanchomepage> {
